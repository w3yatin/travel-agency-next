                    ...
                    <div className="lg:col-span-6 col-span-12">
                        <div className="xl:pt-12.5 2xl:ps-5">
                            ...
                            <form className="dz-form dzForm" >
                                ...
                                <input type="hidden" className="py-2.75 text-lg border-b-2 border-[#383B3F] placeholder:text-lightgrey text-lightgrey h-12.5 w-full" name="dzToDo" value="Contact" />
                                <input type="hidden" className="py-2.75 text-lg border-b-2 border-[#383B3F] placeholder:text-lightgrey text-lightgrey h-12.5 w-full" name="reCaptchaEnable" value="0" />
                                ...
                                <div className="row">
                                    ...
                                    <div className="w-full">
                                        <div className="input-recaptcha mb-10">
                                            ...
                                            <input className="form-control hidden" style={{display:`none`}} data-recaptcha="true" required data-error="Please complete the Captcha" />
                                        </div>
                                    </div>
                                    <div className="w-full">
