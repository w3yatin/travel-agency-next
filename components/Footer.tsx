                    ...
                    <div className="py-7.5">
                        <div className="row">
                            <div className="xl:w-1/4 w-full max-xl:mb-2.5">
                                <p className="2xl:text-base text-2sm mb-0 max-xl:text-center">© Copyright <span className="current-year">2026</span> By <Link href="https://themeforest.net/user/dexignzone" target="_blank" className="text-secondary">DexignZone</Link>.</p>
                            </div>
                            <div className="xl:w-1/2 w-full max-xl:mb-2.5 max-sm:hidden">
                                <ul className="flex items-center justify-center gap-1">
                                    ...
                                    <li>
                                        <Link href="/contact-us-2" className="2xl:px-5 px-2 py-1 text-2sm font-medium">Contact</Link>
                                    </li>
                                </ul>
                            </div>
