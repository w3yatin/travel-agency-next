...
>
	...
	<div className="main-bar relative lg:text-white text-secondary w-full">
		<div className="container-fluid flex items-center">
			...
			<button aria-label="Open menu" className="xmenu-toggler lg:hidden float-right sm:mt-4.5 sm:mb-4 sm:ml-7 ml-4 my-2.5 size-11 bg-secondary rounded-md relative cursor-pointer max-lg:order-1" type="button">
			...
			<div className="flex lg:basis-auto lg:mx-auto max-lg:flex-col lg:justify-center justify-start lg:items-center max-lg:fixed max-lg:h-screen max-lg:px-5 max-lg:top-0 max-lg:-left-75 max-lg:z-9999 max-lg:w-72 max-lg:overflow-auto max-lg:duration-700 header-nav custom-scroll lg:rounded-6xl lg:bg-secondary/30 bg-white p-1.5 [.header-nav.show]:left-0">
				<div className="flex items-center relative z-9 py-6.25 lg:hidden w-33.75 h-15.25">
					<Link aria-label="Go to homepage" href="index.html" className="table-cell align-middle">
						<Image src={IMAGES.logo} alt="logo" className="object-contain duration-500" />
					</Link>
				</div>
