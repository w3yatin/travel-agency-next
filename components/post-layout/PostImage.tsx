...
export default function PostImage({ blog }: BlogProps) {
    return(
                    ...
                    <div className="xl:w-3/4 w-full mb-7.5 xl:ps-12!">
                        <div className="sm:pb-7.5 pb-3.75">
                            ...
                            <div className="relative overflow-hidden">
                                <Image src={blog.image} alt={blog.title}  blurDataURL="/images/blur.png" className="size-full object-cover" width={525} height={934}/>
                            </div>
                        </div>
                        <div className="mb-5">
