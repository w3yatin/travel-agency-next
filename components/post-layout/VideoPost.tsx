...
export default function VideoPost({ blog }: BlogProps) {
    return(
                    ...
                    <div className="xl:w-3/4 w-full mb-7.5 xl:ps-12!">
                        <div className="sm:pb-7.5 pb-3.75">
                            ...
                            <div className="relative overflow-hidden">
                                <iframe className="md:h-127.5 sm:h-87.5 h-62.5 w-full" src="https://www.youtube.com/embed/tVphpcFHGaI" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen title="YouTube video player: Video"></iframe>
                            </div>
                        </div>
                        <div className="mb-5">
