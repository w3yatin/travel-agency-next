                    ...
                    <div className="xl:w-3/4 w-full mb-7.5 xl:ps-12!">
                        <div className="sm:pb-7.5 pb-3.75">
                            ...
                            <div className="bg-light relative w-full md:h-100 sm:h-87.5 h-62.5 flex">
                                ...
                                <div className="flex items-center justify-center text-center p-5"><p className="font-medium xl:text-2xxl sm:text-2xl text-xl text-secondary">“Lorem Ipsumipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the”</p></div>
                            </div>
                        </div>
                        <div className="mb-5">
