...
export default function AudioPost({ blog }: BlogProps) {
    return(
                    ...
                    <div className="xl:w-3/4 w-full mb-7.5 xl:ps-12!">
                        <div className="sm:pb-7.5 pb-3.75">
                            ...
                            <div className="relative overflow-hidden">
                                <iframe className="md:h-127.5 sm:h-87.5 h-62.5 w-full" src="https://w.soundcloud.com/player/?visual=true&#038;url=https://soundcloud.com/secret-service-862007284/old-town-road&#038;show_artwork=true&#038;maxwidth=750&#038;maxheight=1000&#038;dnt=1" title="SoundCloud audio player: Old Town Road"></iframe>
                            </div>
                        </div>
                        <div className="mb-5">
