...
export default function LinkPost({ blog }: BlogProps) {
    return(
                ...
                <div className="row">
                    ...
                    <div className="xl:w-3/4 w-full mb-7.5 xl:ps-12!">
                        <div className="sm:pb-7.5 pb-3.75">
                            ...
                            <div className="relative overflow-hidden after:absolute after:top-0 after:left-0 after:size-full after:bg-black/50 after:backdrop-blur-[5px]">
                                <Image  src={blog.image} alt="img"  blurDataURL="/images/blur.png" className="size-full object-cover" width={525} height={934} />
                                <Link className="bg-white/80 text-black absolute top-1/2 left-1/2 -translate-1/2 w-4/5 md:h-20 h-12.5 text-xl font-medium flex items-center justify-center z-1 hover:bg-primary" target="_blank" href="https://www.dexignzone.com/">DexignZone</Link>
                            </div>
                        </div>
                        <div className="mb-5">
