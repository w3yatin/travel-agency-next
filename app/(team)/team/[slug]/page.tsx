                        ...
                        <div className="xl:col-span-6 col-span-12">
                            <div className="pxl-heading-scroll-effect">
                                ...
                                <div className="xl:mt-5">
                                    ...
                                    <div className="flex items-center text-sm dark:text-white gap-8">
                            ...
                            <div className="xl:my-10 my-40">
                                <h5 className="text-2xl dark:text-white font-semibold mb-7">Experience</h5>
                                <ul className="">
                                    <li className="flex items-center gap-x-20 mb-3">
                                        <span className="text-sm font-normal text-[#999] dark:after:bg-white/20 after:bg-black/20 after:size-2 after:rounded-full after:absolute after:mx-5 after:top-8 after:-right-20 relative">2019–2026</span>
                            ...
                            <div className="xl:mb-6 mb-40">
                                <h5 className="text-2xl dark:text-white font-semibold mb-8">Awards</h5>
                                <div className="grid grid-cols-12 gap-15">
                                    <div className="md:col-span-6 col-span-12">
                                        <div className="p-10 dark:bg-white/10 bg-black/10 text-center group hover:bg-primary duration-500">
                                            <ul className="flex items-center justify-center text-base font-medium  group-hover:text-black dark:text-white  text-center duration-500">
                                                <li>2026</li>
                                                <li className="size-2 rounded-full dark:bg-white/40 bg-black/40 mx-3 duration-500"></li>
                                                <li>Nominee</li>
                                            </ul>
                                            <div className="py-11 flex justify-center">
                                                <div className="size-27 group-hover:bg-black dark:bg-white bg-black rounded-full flex items-center justify-center duration-500">
                            ...
                            <TeamSwiper />
                            <div className="grid grid-cols-12 gap-15 xl:mb-20 mb-40">
                            ...
                            <div className="grid grid-cols-12 xl:mb-30 mb-40">
                                <div className="col-span-12"><h5 className="text-2xl dark:text-white font-semibold mb-8">Contact Us</h5></div>
                                <div className="col-span-12">
                                    <form>
                                        <div className="grid grid-cols-12 gap-x-16">
                                            <div className="lg:col-span-6 col-span-12">
                                                <label htmlFor="fullname" className="block text-label font-normal mb-3 dark:text-white text-black">Full name*</label>
                                                <input id="fullname" className="w-full h-12 mr-16 mb-6 py-4 px-5 outline-none dark:bg-white/20 bg-black/20 text-base font-medium dark:text-white text-black" type="text" name="dzName" placeholder="John carter" />
                                            </div>
                                            <div className="lg:col-span-6 col-span-12">
                                                <label htmlFor="email" className="block text-label font-normal mb-3 dark:text-white text-black">Email address*</label>
                                                <input id="email" className="w-full h-12 mr-16 mb-6 py-4 px-5 outline-none dark:bg-white/20 bg-black/20 text-base font-medium dark:text-white text-black" type="email" name="dzEmail" placeholder="info@example.com" />
                                            </div>
                                            <div className="col-span-12">
                                                <label htmlFor="website" className="block text-label font-normal mb-3 dark:text-white text-black">Website link</label>
                                                <input id="website" className="w-full h-12 mr-16 mb-6 py-4 px-5 outline-none dark:bg-white/20 bg-black/20 text-base font-medium dark:text-white text-black" type="text" name="link" />
                                            </div>
                                            <div className="col-span-12">
                                                <label htmlFor="help" className="block text-label font-normal mb-3 dark:text-white text-black">How Can We Help You*</label>
                                                <textarea id="help" name="dzMessage" required placeholder="Write A Message..." className="w-full h-45 py-4 px-5 outline-none dark:bg-white/20 bg-black/20 text-base font-medium dark:text-white text-black mb-6"></textarea>		
                                            </div>
                                            <div className="col-span-12">
                                               <Link className="btn btn-primary btn-hover" href="/">
                                                    Submit Now
