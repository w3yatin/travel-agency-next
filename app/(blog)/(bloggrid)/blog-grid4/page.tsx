...
export default function BlogGrid4() {
    ...
    const loadMore = () => {
        setVisibleCount((prev) => Math.min(prev + 8, bloggridData.length));
    };
    return(
            ...
            <div className="container-fluid">
                <div className="grid grid-cols-12 gap-5 loadmore-content">
                    {visibleBlogs.map((bloggrid, index) => (
                        <div className="2xl:col-span-3 xl:col-span-4 md:col-span-6 col-span-12" key={index}>
                ...
                <div className="w-full text-center mt-2.5">
                    <button type="button" 
                     onClick={loadMore}
                    className="btn btn-primary btn-hover group dz-load-more" rel="ajax/blog-4.html">
                        <span>Load More</span>
